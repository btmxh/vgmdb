...
class TestArtists(unittest.TestCase):
    ...
    def test_nobuo(self):
        ...
        self.assertEqual(
            "Dog Ear Records", nobuo["info"]["Organizations"][0]["names"]["en"]
        )
        ...
        self.assertEqual(
            "CRUISE CHASER BLASSTY", nobuo["discography"][0]["titles"]["en"]
        )
        ...
        self.assertEqual(
            "https://thumb-media.vgm.io/artists/77/77/77-1345913713.jpg",
            nobuo["picture_small"],
        )
        self.assertEqual(
            "https://media.vgm.io/artists/77/77/77-1345913713.jpg",
            nobuo["picture_full"],
        )
