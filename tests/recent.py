...
class TestRecent(unittest.TestCase):
    ...
    def test_albums(self):
        html = open(os.path.join(base, "recent_albums.html"), "r").read()
        ...
        self.assertEqual(
            "https://vgmdb.net/forums/member.php?u=10807", up[0]["contributor"]["link"]
        )
        self.assertEqual("2013-10-20T15:40", up[0]["date"])

    def test_media(self):
        html = open(os.path.join(base, "recent_media.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
        ...
        self.assertEqual(
            "https://vgmdb.net/forums/member.php?u=606", up[0]["contributor"]["link"]
        )
        self.assertEqual("2013-10-20T15:11", up[0]["date"])

    def test_tracklists(self):
        html = open(os.path.join(base, "recent_tracklists.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
    ...
    def test_scans(self):
        html = open(os.path.join(base, "recent_scans.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
        ...
        self.assertEqual(
            "https://vgmdb.net/forums/member.php?u=65", up[0]["contributor"]["link"]
        )
        self.assertEqual("2013-10-20T15:43", up[0]["date"])
        self.assertEqual("boogiepop", up[-1]["contributor"]["name"])
        self.assertEqual(
            "https://vgmdb.net/forums/member.php?u=11507", up[-1]["contributor"]["link"]
        )
        self.assertEqual("2013-10-20T07:56", up[-1]["date"])

    def test_artists(self):
        html = open(os.path.join(base, "recent_artists.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
        ...
        self.assertEqual(
            "https://vgmdb.net/forums/member.php?u=10807", up[-1]["contributor"]["link"]
        )
        self.assertEqual("2013-10-20T11:28", up[-1]["date"])

    def test_products(self):
        html = open(os.path.join(base, "recent_products.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
        ...
        self.assertEqual(
            "https://vgmdb.net/forums/member.php?u=13861", up[0]["contributor"]["link"]
        )
        self.assertEqual("2013-10-19T06:50", up[0]["date"])

    def test_labels(self):
        html = open(os.path.join(base, "recent_labels.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
    ...
    def test_links(self):
        html = open(os.path.join(base, "recent_links.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
        ...
        self.assertEqual(
            "https://vgmdb.net/redirect/65785/www.amazon.co.jp/dp/B00FXMYERU/",
            up[1]["link_data"]["link"],
        )
    ...
    def test_ratings(self):
        html = open(os.path.join(base, "recent_ratings.html"), "r").read()
        data = recent.parse_page(html)
        up = data["updates"]
        ...
        self.assertEqual(
            "https://vgmdb.net/forums/member.php?u=1254", up[0]["contributor"]["link"]
        )
