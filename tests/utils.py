...
class TestLinks(unittest.TestCase):
    def test_trim_absolute(self):
        ...
        self.assertEqual(
            "http://wikipedia.org/album/29",
            utils.trim_absolute("http://wikipedia.org/album/29"),
        )
        self.assertEqual(
            "https://wikipedia.org/album/29",
            utils.trim_absolute("https://wikipedia.org/album/29"),
        )
    ...
    def test_force_absolute(self):
        ...
        self.assertEqual(
            "http://wikipedia.org/album/29",
            utils.force_absolute("http://wikipedia.org/album/29"),
        )
        self.assertEqual(
            "https://www.facebook.com/akadress",
            utils.force_absolute("https://www.facebook.com/akadress"),
        )
    ...
    def test_strip_redirect(self):
        self.assertEqual(
            "http://www.mobygames.com/game/clannad",
            utils.strip_redirect(
                "https://vgmdb.net/redirect/43446/www.mobygames.com/game/clannad"
            ),
        )
        self.assertEqual(
            "http://www.mobygames.com/game/clannad",
            utils.strip_redirect("/redirect/43446/www.mobygames.com/game/clannad"),
        )
        self.assertEqual(
            "http://www.mobygames.com/game/clannad",
            utils.strip_redirect("/redirect/0/www.mobygames.com/game/clannad"),
        )
        self.assertEqual(
            "https://www.facebook.com/akadress",
            utils.strip_redirect("/redirect/63221/https://www.facebook.com/akadress"),
        )
        self.assertEqual(
            "http://musenote.blog10.fc2.com/blog-entry-187.html",
            utils.strip_redirect(
                "/redirect/79973/vgmdb.net/redirect/79964/musenote.blog10.fc2.com/blog-entry-187.html"
            ),
        )
